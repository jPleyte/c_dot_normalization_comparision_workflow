...
def main():
    ...
    norm_vep = NormalizeVepTsv()
    
    norm_vep.read_vep_file(args.input)
    variant_transcripts = norm_vep.get_variant_transcripts()
    norm_vep.write(args.output, variant_transcripts)
